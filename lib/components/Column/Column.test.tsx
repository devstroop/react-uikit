...
describe("Column", () => {
  ...
  it("applies responsive tier classes for xs–xx", () => {
    const { container } = render(
      <Column sizeXs={12} sizeSm={6} sizeMd={6} sizeLg={3} sizeXl={4} sizeXx={6} offsetXs={1} offsetSm={2} offsetXx={3} />
    );
...
describe("Column order (Radzen parity)", () => {
  ...
  it("applies responsive order classes per breakpoint", () => {
    const { container } = render(<Column orderSm="last" orderMd={1} orderXl="first" orderXx={2} />);
