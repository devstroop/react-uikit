...
describe('Pager', () => {
  ...
  it('fires onPageChange with PageEventArgs', () => {
    ...
    render(
      <Pager page={2} pageSize={10} count={35} onPageChange={onPageChange} />
    );
  ...
  it('renders custom summary template', () => {
    render(
      <Pager
        ...
        pageSize={10}
        count={35}
        pagingSummaryTemplate={({ count }) => `${count} total`}
      />
    );
  ...
  it('formats pagingSummaryFormat', () => {
    render(
      <Pager
        ...
        pageSize={10}
        count={35}
        pagingSummaryFormat="Showing {0}/{1} of {2}"
      />
    );
  ...
  it('hides when single page unless alwaysVisible', () => {
    const { container, rerender } = render(
      <Pager page={1} pageSize={10} count={5} />
    );
  ...
  it('applies horizontalAlign class', () => {
    const { container } = render(
      <Pager page={1} pageSize={10} count={35} horizontalAlign="center" />
    );
  ...
  it('renders nothing when visible is false', () => {
    const { container } = render(
      <Pager page={1} pageSize={10} count={35} visible={false} />
    );
