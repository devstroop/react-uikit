  ...
  return (
    ...
    >
      <div className={styles.header} role="row">
        ...
        <div className={styles.timeline} role="columnheader">
          Timeline ({view})
        </div>
      </div>
      {tasks.map((task) => (
        <div
          ...
          role="row"
          aria-selected={selected === task.id}
        >
          <div className={styles.taskName} role="gridcell">
            {task.name}
          </div>
          <div className={styles.timelineCell} role="gridcell">
            ...
            {task.dependencies?.map((dep) => (
              <svg key={dep} className={styles.dep} aria-hidden="true">
                <line
                  x1="0"
                  y1="10"
                  x2="20"
